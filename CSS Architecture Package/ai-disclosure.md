...
**Verification.** I checked Home, About, Media, and Services in Chrome at about 375px and a wide window. Nav wraps with no sideways overlap. Cards and the About video/bio stack on a small screen. Focus, the Services form error state, and Services print preview still work.
